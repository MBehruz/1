...
const Light = () => {
  ...
  return (
    <div>
       {loading ?
        (
          <div className='w-[100%] h-screen bg-[#ffff]'>
         <Loader />
          </div>
        ) : (
      <div>
        <Header/>
        <Home />
        <div className='bg-[#ffff] grid justify-center items-center'>
        <Card />
        <About />
        <Work />
      </div>
      <Footer />
      <div className='h-[70px] xl:px-[280px] lg:justify-start lg:px-[60px] text-[#6E6E6E] px-4 grid justify-center items-center'>
